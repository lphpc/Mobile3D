...
public class Photo3DAct extends Activity {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_DPAD_CENTER:
                ...
                Jade.nativeSetTextureOffset (0.0f, texureOffset, 0.0f );
    ...
    public boolean onTouchEvent(final MotionEvent event) {
        ...
        if (eventAction == MotionEvent.ACTION_DOWN) {
            ...
            if ((x - downX) != 0) {
                ...
                //Log.d ("Photo3DAct", "x = " + x + " downX = " + downX + "angleY = " + angleY);
            }
            ...
            if ((y - downY) != 0) {
                ...
                //Log.d ("Photo3DAct", "y = " + y + " downY = " + downY + "angleX = " + angleX);
            }


            //Jade.nativeSetRotate (0.0f, angleY, 0.0f);
...
class DemoRenderer implements GLSurfaceView.Renderer {
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        Jade.nativeInit(320, 480);
        Jade.nativeSetScale (1.0f, 1.0f, 1.0f);
    }
